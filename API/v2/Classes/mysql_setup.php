		...
		public function select_query($function, $where_values){
			...
			switch($function){
				...
				case "room_consumptions":
					$query = "SELECT room_consumptions.room_consumptions_id, rooms.rooms_id, room_consumptions.room_consumptions, rooms.rooms_name, rooms.rooms_port, rooms.rooms_status FROM room_consumptions INNER JOIN rooms ON room_consumptions.rooms_id=rooms.rooms_id";
					break;
				case "room_devices":
